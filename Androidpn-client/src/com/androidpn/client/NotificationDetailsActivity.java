...
public class NotificationDetailsActivity extends Activity {
     ...
     */
    private void toActivity( String notificationUri) {
//    	String[] str = notificationUri.split(",");
//    	String url = str[0];
//    	String action = str[1];
 
    	
    	Intent intent = new Intent( "com.cx.project.zhihudaily.detail.push");
    	intent.putExtra("id",Long.valueOf(notificationUri));
